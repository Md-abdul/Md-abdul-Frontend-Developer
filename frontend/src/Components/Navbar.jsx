...
//                   <span className="text-white text-lg font-zlogo ml-2 -mt-10">
//                     Saviour
//                   </span>
//                 </div>
//               </div>
//               <div className="hidden md:flex md:items-center md:space-x-4 flex-grow justify-center bg-black  mt-10 rounded-full font-2xl">
//                 <Link
//                   to="/home"
